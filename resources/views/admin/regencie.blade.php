          ...
          <div class="x_panel">
            ...
            <div class="x_content">
                <p class="text-muted font-13 m-b-30">
                  ...
                  <table id="datatableRegencies" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th rowspan="2" style="vertical-align : middle;text-align:center;">No</th>
                        <th rowspan="2" style="vertical-align : middle;text-align:center;">Regencie</th>
