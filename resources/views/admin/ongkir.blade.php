    ...
    <div class="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <select class="form-control" name="regencies" id="regencies">
                                        <option disabled="true">Choose Province First</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <select class="form-control" name="districts" id="districts">
                                        <option disabled="true">Choose Regencies First</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <select class="form-control" name="villages" id="villages">
                                        <option disabled="true">Choose District First</option>
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">Add Data Ongkir</button>
            <div class="x_title">
              <h2>Plain Page</h2>
