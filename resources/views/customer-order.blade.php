                ...
                <div class="basket-body">
                  ...
                  <div class="item">
                    <div class="row d-flex align-items-center">
                      <div class="col-6">
                        <div class="d-flex align-items-center"><img src="https://d32d8xzgnjxuvk.cloudfront.net/hub/1-2/img/shirt.png" alt="..." class="img-fluid">
                  ...
                  <div class="item">
                    <div class="row d-flex align-items-center">
                      <div class="col-6">
                        <div class="d-flex align-items-center"><img src="https://d32d8xzgnjxuvk.cloudfront.net/hub/1-2/img/shirt-black.png" alt="..." class="img-fluid">
                          <div class="title"><a href="detail.html">
