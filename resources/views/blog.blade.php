    ...
    <section class="blog">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="post post-gray d-flex align-items-center flex-md-row flex-column">
              <div class="thumbnail d-flex-align-items-center justify-content-center"><img src="https://d32d8xzgnjxuvk.cloudfront.net/hub/1-2/img/blog2.jpg" alt="..."></div>
              <div class="info"> 
          ...
          <div class="col-lg-6">
            <div class="post post-gray d-flex align-items-center flex-md-row flex-column">
              <div class="thumbnail d-flex-align-items-center justify-content-center"><img src="https://d32d8xzgnjxuvk.cloudfront.net/hub/1-2/img/blog1.jpg" alt="..."></div>
              <div class="info"> 
